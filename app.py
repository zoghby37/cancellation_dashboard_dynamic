...
TESH_COLORS = ['#2B6A6C', '#C9A227', '#3d8a8c', '#d4af37', '#1E4E4F', '#a68521']
            ...
            with col1:
                ...
                if len(paid_orders) > 0:
                    ...
                    fig_type = px.pie(
                        ...
                        color_discrete_sequence=TESH_COLORS
                    )
            ...
            if 'Business Hour' in paid_orders.columns and paid_orders['Business Hour'].notna().any():
                ...
                with col1:
                    fig_hourly_count = px.bar(
                        ...
                        color='Order Count',
                        color_continuous_scale=[[0, '#1E4E4F'], [0.5, '#2B6A6C'], [1, '#3d8a8c']]
                    )
                ...
                with col2:
                    fig_hourly_revenue = px.bar(
                        ...
                        color='Total Revenue',
                        color_continuous_scale=[[0, '#a68521'], [0.5, '#C9A227'], [1, '#d4af37']]
                    )
            ...
            if 'Business Date' in paid_orders.columns and paid_orders['Business Date'].notna().any():
                ...
                fig_daily.add_trace(
                    go.Bar(x=daily_stats['Business Date'], y=daily_stats['Order Count'], 
                           name="Orders", marker_color=TESH_TEAL),
                    secondary_y=False
                )
                fig_daily.add_trace(
                    go.Scatter(x=daily_stats['Business Date'], y=daily_stats['Total Revenue'], 
                               name="Revenue", line=dict(color=TESH_GOLD, width=3)),
                    secondary_y=True
                )
        ...
        with tab4:
            ...
            if len(paid_orders) > 0:
                ...
                fig_scatter = px.scatter(
                    ...
                    color_continuous_scale=[[0, '#1E4E4F'], [0.5, '#2B6A6C'], [1, '#C9A227']]
                )
                ...
                if 'Business Hour' in paid_orders.columns and paid_orders['Business Hour'].notna().any():
                    ...
                    fig_heatmap = px.density_heatmap(
                        ...
                        color_continuous_scale=[[0, '#1E4E4F'], [0.3, '#2B6A6C'], [0.7, '#C9A227'], [1, '#d4af37']]
                    )
